Rails.application.routes.draw do
  ...
  namespace :api do
    namespace :v1 do
      ...
      get    "gift_catalog",         to: "gift_catalog#index"
      ...
      get    "events/:slug/:token/rsvps/lookup", to: "rsvps#lookup"
      post   "events/:slug/:token/rsvps",        to: "rsvps#create"
      post   "events/:slug/:token/rsvps/add_companions", to: "rsvps#add_companions"
