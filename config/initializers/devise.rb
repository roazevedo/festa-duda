...
Devise.setup do |config|
  ...
  # config.secret_key = 'd472c40451044226e836dd398ca1b4000c8963214a70b37c254cac3f5ec5e6a16d6dd0abbebc02748eea7f2b678b749156f13269d91ad99fd3afdfba339cb3fd'
  ...
  # config.pepper = '2321e61721761a0fc6c37f8924592d9aa8852b6e24b6482d81c77b884dcf2929e778f1699052596401d2e98be4105f4f0cbfd90cb5facebac2f963bbe03c73d9'
  ...
  config.jwt do |jwt|
    ...
    # O cadastro (/signup) NÃO emite mais JWT: o token só é emitido depois
    # que o e-mail é confirmado pelo código (/email_verifications/verify).
    jwt.dispatch_requests = [
      [ "POST", %r{^/api/v1/login$} ],
      [ "POST", %r{^/api/v1/email_verifications/verify$} ],
